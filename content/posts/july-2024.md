...
- Added [Stremio Tools](https://gofmhy.tech/video#stremio-tools) section
  to Streaming.

- Added [Video Generation](https://gofmhy.tech/ai#video-generation) section to AI.

- Added [Audio Transcription](https://gofmhy.tech/text-tools#audio-transcription)
  section to Text Tools.

- Added [System Audio](https://gofmhy.tech/system-tools#system-audio) and
  [USB / Bootloaders](https://gofmhy.tech/system-tools#usb-bootloaders) sections to
  System Tools.

- Added [Network Security](https://gofmhy.tech/privacy#network-security)
  section to Privacy.

- Added
  [Fanfiction / Stories](https://gofmhy.tech/reading#fanfiction-stories)
  section to Reading.

- Added [Audio Metadata](https://gofmhy.tech/audio#audio-metadata)
  section to Audio.

- Added [Wayland Compositors](https://gofmhy.tech/linux-macos#wayland-compositors)
  section to Linux.

- Added [LaTeX Tools](https://gofmhy.tech/storage#latex-tools) section to Math.

- Turned [Email Tools](https://gofmhy.tech/internet-tools#email-tools) into a main
  section with subsections.

- Split the Subtitle section into
  [Tools](https://gofmhy.tech/video#subtitles) and
  [Downloads](https://gofmhy.tech/video#download-subtitles).
...
- Cleaned up [Video Hosts](https://fmhy.pages.dev/video-tools#video-file-hosts),
  [Image Optimization](https://gofmhy.tech/image-tools#image-optimization), and
  [Icons / Avatars](https://gofmhy.tech/image-tools#icons-avatars) sections.
...
- Starred [Hidan](https://gofmhy.tech/file-tools#file-hosts) in File Hosts. Fast,
  unlimited size, no account required; publishes when they remove files.

- Starred [Catppuccin](https://gofmhy.tech/system-tools#custom-themes) in Custom
  Themes. High-quality pastel system app themes.

- Starred [Bio Link](https://gofmhy.tech/internet-tools#link-in-bio-sites) in Link
  in Bio Sites. Feature-rich, nice UI; stood out to us when going through the
  section.

- Starred [RetroAchievements](https://gofmhy.tech/gaming#emulators) in
...
- Starred [sdk.vercel](https://gofmhy.tech/ai#online-chatbots) in Online Chatbots.
  Chatbot playground with unlimited GPT-4o.

- Starred [FossifyOrg](https://gofmhy.tech/mobile#foss-apks) in FOSS
  APKs. Covers most basic apps, minimal UI.

- Starred
  [Universal Android Debloater](https://gofmhy.tech/mobile#optimization)
  in Android Optimization. Updated fork of the original UAD.

- Starred [Amarok](https://gofmhy.tech/mobile#android-privacy) in Android
  Privacy. Easily hide private files / apps on Android.

- Starred [Sideloadly](https://gofmhy.tech/mobile#ios-apps) in iOS Apps.
  Lightweight, simple setup, and auto-updates apps.

- Starred [EeveeSpotify](https://gofmhy.tech/mobile#ios-audio) in iOS
  Audio. Updated Spotify premium app now that Spotilife has stopped working.

- Starred [S0undTV](https://gofmhy.tech/mobile#smart-tv-firestick) in
  Firestick. Ad-free Twitch for Firestick.

- Starred [Uncyclopedia](https://gofmhy.tech/misc#random) in Fun Sites.

- Added star back to [Bloxstrap](https://gofmhy.tech/gaming-tools#roblox-tools).
